...
```{r}
calculating_mean <- data_dnd |>
  select(agree_mean, con_mean, extr_mean, neuro_mean, open_mean) 
  
overall_mean_agree <- calculating_mean |>
  dplyr::summarize(mean_agree_mean = mean(agree_mean, na.rm = TRUE))
