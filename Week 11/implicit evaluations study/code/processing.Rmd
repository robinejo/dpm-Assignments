...
# combine all dfs created in the previous chunks3
...
Note to myself: Create a codebook where you define what each item stands for. Explain the names you used in your code (z.B. extra_r).
