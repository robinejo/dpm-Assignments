...
r.corr(as.matrix(correlations), type=c("spearman")) #doesn't work at the moment. Has to be redone
```
...
ggsave("combined_plot.pdf", combined_plot, width = 15, height = 5)

# Save the plot as a PNG
ggsave("../code/combined_plot.png", combined_plot, width = 15, height = 5, dpi = 300)
```
